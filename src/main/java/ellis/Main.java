...
public class Main {
    ...
    private static final String[] ISSUES_LIST = { "Accurate IDs", "Civil Rights", "Free Speech & Expression",
            "Healthcare",
    ...
    public static void main(String[] args) throws IOException, CsvValidationException {
        ...
        DecodeToPDF pdfThings = new DecodeToPDF();
        Legiscan test;
        ...
        saveData();
        pdfThings.printBillIDList();
        // pdfThings.createTextFiles(); will have more api calls
        // pdfThings.saveHashValues();
        pdfThings.convertToPDF();
         ...
         * case 'b':
         * System.out.
         * println("Which bills would you like to add (separate by a comma no space)?");
         * break;
         * case 'c':
         ...
         * try {
         * content = new
         * String(Files.readAllBytes(Paths.get("billFiles/allSessions.json")));
         ...
         * CsvWriteOptions.builder("billFiles/sessionsOutput.csv").build();
         ...
         * 
         * // We only want to process files (not directories) and only files that end
         * with
         * // .json
         ...
         * stateSessionBillsMap =
         * processor.loadFromFile("otherBillFiles/fullMapData2.ser");
         * 
         * // System.out.println(stateSessionBillsMap.get(1).get(29).get(0).getNumber().
         * toString());
    ...
    public static void saveData() {
        try {
            ...
            for (int i = 0; i < allData.size(); i++) {
                ...
                writer.println();
                // writer.println(allData.get(i)[0] + FILE_DELIMITER + allData.get(i)[1] +
                // FILE_DELIMITER +
                // allData.get(i)[2] + FILE_DELIMITER + allData.get(i)[3] + FILE_DELIMITER +
                // allData.get(i)[4] +
                // FILE_DELIMITER + allData.get(i)[5] + FILE_DELIMITER + allData.get(i)[6] +
                // FILE_DELIMITER
                // + allData.get(i)[7]);
            }
            writer.close();
